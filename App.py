...
class App():
    ...
    def __init__(self) -> None:
        ...
        #lines shower öncekileri göstermek ve yeni eklenenleri göstermek için 
        self.linesshowerbool=True
            ...
            if self.editbool:
                ...
                if self.careditbool:
                    ...
                    if event.type==pygame.MOUSEBUTTONDOWN and not (self.mousx>900 and self.mousy<150):
                        ...
                        self.mycar=LineRect(self.screen,self.mouspos,self.linearrL,self.linearrF)
